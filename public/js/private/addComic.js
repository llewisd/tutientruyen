...
document.addEventListener('DOMContentLoaded', () => {
     ...
     reset_button.forEach(item => {
          item.addEventListener('click', function(e) {
               const flag_value = e.target.previousElementSibling.innerHTML;
...
document.addEventListener('DOMContentLoaded', () => {
     ...
     addComic_button.addEventListener('click', function(e) {
          ...
          genre_select.addEventListener('change', function(e) {
               ...
               `;
               genre_list.insertAdjacentHTML('beforeend', genre_item);
          ...
          addComic_form.addEventListener('submit', async function(e) {
               e.preventDefault(); 
               ...
               //      formData.image = image_field.files[0];
               // }
